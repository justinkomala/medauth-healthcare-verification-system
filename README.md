...
## Key Features
- Barcode-based medicine verification
- Blockchain-backed authenticity record
- Consumer mobile app prototype
- Healthcare worker verification flow
- Offline scanning support
- Medicine history and safety alerts
- Role-based access for consumers, pharmacists and regulators
- Privacy-focused data design

## My Role
I contributed as a Business and Systems Analyst by analysing the problem, identifying stakeholders, defining system requirements, developing process and data models and designing a user-centred prototype.
